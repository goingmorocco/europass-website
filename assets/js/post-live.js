...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Post body is admin-authored rich text (from the Quill editor in the admin
  // portal), not public user input, so rendering it as HTML here is the
  // correct and standard approach — same trust boundary as any CMS.
